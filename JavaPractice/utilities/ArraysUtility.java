...
public class ArraysUtility {
    ...
    public static int max(int[] numbers) {
        Arrays.sort(numbers);      //sorts the array from smallest to biggest element
        return numbers[numbers.length - 1];   //prints the last element of the array which holds the maximum value
    }
    ...
    public static int min(int[] numbers) {
        Arrays.sort(numbers);      //sorts the array from smallest to biggest element
        return numbers[0];   //prints the first element of the array which holds the minimum value
    }
    ...
    //removes the element with the given index from the array, returns new array
    ...
    //removes the elment with the given index from the array, returns new array
    ...
    //passes three parameters: integer array, integer index, integer element, returns the new array
    // Ex: arr = {10, 20, 30, 40, 50};  insert(arr, 2, 100) ==> {10, 20, 100, 30, 40, 50}
    ...
    //passes three parameters: integer array, integer i, integer j. the method swaps the element at index i with the element at index j, and returns the new array
    //Ex: arr = {10, 20, 30, 40, 50};   swap(arr, 2, 4) ==>  {10, 20, 50, 40, 30}
